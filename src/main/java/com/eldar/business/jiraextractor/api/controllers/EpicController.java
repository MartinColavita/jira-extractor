...
public class EpicController extends SwaggerResponseCode {
    ...
    @Parameters({ @Parameter(name = "epicIdOrKey", description = " epicIdOrKey", example = "") })
    public ResponseEntity<EpicDTO> getEpic(@PathVariable Long epicIdOrKey) {
        log.info(" #### endpoint getEpic ####");
    ...
    @Parameters({ @Parameter(name = "epicId", description = " Epic ID", example = "") })
    public ResponseEntity<BacklogDTO> getIssuesForEpic(@PathVariable Long epicIdOrKey) {
        log.info(" #### endpoint getIssuesForEpic ####");
